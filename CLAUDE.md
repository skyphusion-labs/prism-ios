...
**Status:** kit 0.5.3 + plane-default UX (balance, photo i2i, video player, share, cancel, picker
search, error map). ASC app `6798391677`. Aviation-grade `main`. Next: plane receipt redeem when
un-parked.
