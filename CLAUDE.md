...
**Status:** kit 0.3 + app with dual backend and streaming on both planes. Aviation-grade `main`
(PR + CI for the package). Next: StoreKit top-up, optional session cookie persistence.
