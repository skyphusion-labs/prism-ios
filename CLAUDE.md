...
**Status:** kit 0.6.1 (context-preserving model switch, store redeem client, spend preview, media
history, retry, TestFlight/ASC docs). ASC app `6798391677`. Aviation-grade `main`.
